/** @author:dereksu @description:http://km.oa.com/group/TGideas/articles/show/243512 @update:2020.07.30 @version:v2.17 **/ var TGMS = (function () {
  var b = {
    isLoadedJs: false,
    isFirstInit: false,
  ...
  var e = {
    ...
    tcssImgLoader: function (i, h) {
      ...
      g.setAttribute(
        "style",
        "display:none;position:fixed;left:-999999px;top:-999999px;width:0;height:0;"
      );
  ...
  var d = {
    ...
    getSeoData: function () {
      c.seoData.title = document.getElementsByTagName("title")[0]
    ...
    getTgmData: function () {
      c.tgmData.shareTitle = e.getMetaData("tgm:shareTitle")
        ? e.getMetaData("tgm:shareTitle")
        : c.seoData.title;
      c.tgmData.shareDesc = e.getMetaData("tgm:shareDesc")
        ? e.getMetaData("tgm:shareDesc")
        : c.seoData.description;
    ...
    setShareInfo: function (f) {
      if (!e.checkObjType(f)) {
        ...
        c.shareData.shareImgUrl = e.slFix(
          e.strTrim(c.tgmData.shareImgUrl, "all")
        );
        ...
        c.shareData.shareTitle = f.shareTitle
          ? f.shareTitle
          : c.tgmData.shareTitle;
        c.shareData.shareDesc = f.shareDesc ? f.shareDesc : c.tgmData.shareDesc;
        c.shareData.shareImgUrl = f.shareImgUrl
          ? f.shareImgUrl
          : c.tgmData.shareImgUrl;
        ...
        c.shareData.shareImgUrl = e.slFix(
          e.strTrim(c.shareData.shareImgUrl, "all")
        );
        ...
        if (typeof f.wxAppId === "string") {
          c.shareData.wxAppId = f.wxAppId;
        }
        if (!c.shareData.shareTitle) {
          alert(
            "TGMobileShareJs\u63d0\u793a\uff1a\n\u5206\u4eab\u6807\u9898\u4e0d\u80fd\u8bbe\u7f6e\u4e3a\u7a7a\uff01"
    ...
    getTcssName: function () {
      b.tcssName =
        c.shareData.actName.replace(/\./g, "_") +
        "." +
        b.fileName.replace(/\./g, "_");
      b.networktypeTcssName =
        c.shareData.actName.replace(/\./g, "_") + ".networktype";
      ...
      if (n) {
        ...
        function f() {
          if (
            ...
            e.checkFunType(WeixinJSBridge.invoke)
          ) {
              ...
              WeixinJSBridge.invoke(
                "shareTimeline",
                {
                  ...
                  link: e.urlFix(
                    ...
                    "tgi.wx.share.timeline"
                  ),
                  desc: c.shareData.shareDesc,
                  title: c.shareData.timelineTitle
                    ? c.shareData.timelineTitle
                    : c.shareData.shareTitle,
                },
                function (o) {
            ...
            WeixinJSBridge.on("menu:share:appmessage", function (i) {
              WeixinJSBridge.invoke(
                "sendAppMessage",
                {
                  ...
                  desc: c.shareData.messageDesc
                    ? c.shareData.messageDesc
                    : c.shareData.shareDesc,
                  title: c.shareData.messageTitle
                    ? c.shareData.messageTitle
                    : c.shareData.shareTitle,
                },
                function (o) {
                          ...
                          if (e.checkObjType(f)) {
                            if (e.checkObjType(f.onShare)) {
                              switch (k[m]) {
                                ...
                                case "qzone":
                                  if (
                                    e.checkFunType(f.onShare.QQToQzoneSuccess)
                                  ) {
                                ...
                                case "message":
                                  if (
                                    e.checkFunType(f.onShare.QQToMessageSuccess)
                                  ) {
                          ...
                          if (e.checkObjType(f)) {
                            if (e.checkObjType(f.onShare)) {
                              switch (k[m]) {
                                ...
                                case "qzone":
                                  if (
                                    e.checkFunType(f.onShare.QQToQzoneCancel)
                                  ) {
                                ...
                                case "message":
                                  if (
                                    e.checkFunType(f.onShare.QQToMessageCancel)
                                  ) {
                                ...
                                case "timeline":
                                  if (
                                    e.checkFunType(f.onShare.QQToTimelineCancel)
                                  ) {
          ...
          c.onInitInfo.qzoneShare = function () {
            ...
            setTimeout(function () {
              window.location.href =
                ...
                encodeURIComponent(
                  e.urlFix(c.shareData.shareLink, "tgi.browser.share.qzone")
                ) +
                "&title=" +
          ...
          c.onInitInfo.sinaWeiboShare = function () {
            ...
            setTimeout(function () {
              window.location.href =
                ...
                encodeURIComponent(
                  e.urlFix(c.shareData.shareLink, "tgi.browser.share.sinaweibo")
                ) +
                "&title=" +
                encodeURIComponent(c.shareData.shareTitle) +
                "&pic=" +
          ...
          c.onInitInfo.qqWeiboShare = function () {
            ...
            setTimeout(function () {
              window.location.href =
                ...
                encodeURIComponent(
                  e.urlFix(c.shareData.shareLink, "tgi.browser.share.qqweibo")
                ) +
                "&title=" +
                encodeURIComponent(c.shareData.shareTitle) +
                "&pic=" +
    ...
    initWXShareAction: function (f) {
      setTimeout(function () {
        if (
          typeof TGIDEASDEREKSUWXJSSDKSUCCESS == "number" &&
          TGIDEASDEREKSUWXJSSDKSUCCESS === 0.91660871
        ) {
          if (
            typeof TGIDEASDEREKSUTGMOBILESHAREJS == "number" &&
            TGIDEASDEREKSUTGMOBILESHAREJS === 0.60705616
          ) {
            d.initWXShare(f, false);
          } else {
      ...
      if (!b.isLoadedJs) {
        ...
        if (b.isWX) {
          ...
          if (l[i - 2] === "qq" && l[i - 1] === "com") {
            k = "https://game.gtimg.cn/images/js/su/WXJssdk.js";
          }
        ...
        if (
          ...
          e.jsLoader(
            "https://open.mobile.qq.com/sdk/qqapi.https.js?_bid=2389",
            d.initMQQShare,
            n
          );
        }
          ...
          var m = function (o) {
            setTimeout(function () {
              if (b.isWXFirstLoad && b.isQQFirstLoad) {
                ...
                d.getTcssName();
                b.isCfgWxjssdk
                  ? d.initWXShare(o, true, b.isCfgWxjssdk)
                  : d.initWXShare(o, false);
                d.printTips(o);
                d.countJsRequest();
                g(o);
              } else {
